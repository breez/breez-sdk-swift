...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_breez_sdk_bindings_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_breez_sdk_bindings_rustbuffer_free(self, $0) }
    }
}
...
public protocol BlockingBreezServicesProtocol : AnyObject {
    ...
    func claimReverseSwap(lockupAddress: String) throws 
    
    func closeLspChannels() throws 
    
    func configureNode(req: ConfigureNodeRequest) throws 
    ...
    func inProgressOnchainPayments() throws  -> [ReverseSwapInfo]
    ...
    func listSwaps(req: ListSwapsRequest) throws  -> [SwapInfo]
    ...
    func onchainPaymentLimits() throws  -> OnchainPaymentLimitsResponse
    ...
    func payOnchain(req: PayOnchainRequest) throws  -> PayOnchainResponse
    
    func paymentByHash(hash: String) throws  -> Payment?
    
    func prepareOnchainPayment(req: PrepareOnchainPaymentRequest) throws  -> PrepareOnchainPaymentResponse
    
    func prepareRedeemOnchainFunds(req: PrepareRedeemOnchainFundsRequest) throws  -> PrepareRedeemOnchainFundsResponse
    ...
    func redeemOnchainFunds(req: RedeemOnchainFundsRequest) throws  -> RedeemOnchainFundsResponse
    
    func redeemSwap(swapAddress: String) throws 
    ...
    func setPaymentMetadata(hash: String, metadata: String) throws 
    
    func signMessage(req: SignMessageRequest) throws  -> SignMessageResponse
    
    func sync() throws 
    
    func unregisterWebhook(webhookUrl: String) throws 
    
    func withdrawLnurl(request: LnUrlWithdrawRequest) throws  -> LnUrlWithdrawResult
    
}

open class BlockingBreezServices:
    BlockingBreezServicesProtocol {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_breez_sdk_bindings_fn_clone_blockingbreezservices(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_breez_sdk_bindings_fn_free_blockingbreezservices(pointer, $0) }
    }

    

    
open func backup()throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_backup(self.uniffiClonePointer(),$0
    )
}
}
    
open func backupStatus()throws  -> BackupStatus {
    return try  FfiConverterTypeBackupStatus.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_backup_status(self.uniffiClonePointer(),$0
    )
})
}
    
open func buyBitcoin(req: BuyBitcoinRequest)throws  -> BuyBitcoinResponse {
    return try  FfiConverterTypeBuyBitcoinResponse.lift(try rustCallWithError(FfiConverterTypeReceiveOnchainError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_buy_bitcoin(self.uniffiClonePointer(),
...
open func checkMessage(req: CheckMessageRequest)throws  -> CheckMessageResponse {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_check_message(self.uniffiClonePointer(),
        FfiConverterTypeCheckMessageRequest.lower(req),$0
    )
})
}
    
open func claimReverseSwap(lockupAddress: String)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_claim_reverse_swap(self.uniffiClonePointer(),
        FfiConverterString.lower(lockupAddress),$0
    )
}
}
    
open func closeLspChannels()throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_close_lsp_channels(self.uniffiClonePointer(),$0
    )
}
}
    
open func configureNode(req: ConfigureNodeRequest)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_configure_node(self.uniffiClonePointer(),
        FfiConverterTypeConfigureNodeRequest.lower(req),$0
    )
}
}
    
open func connectLsp(lspId: String)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_connect_lsp(self.uniffiClonePointer(),
...
open func disconnect()throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_disconnect(self.uniffiClonePointer(),$0
    )
}
}
    
open func executeDevCommand(command: String)throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_execute_dev_command(self.uniffiClonePointer(),
...
open func fetchFiatRates()throws  -> [Rate] {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_fetch_fiat_rates(self.uniffiClonePointer(),$0
    )
})
}
    
open func fetchLspInfo(lspId: String)throws  -> LspInformation? {
    return try  FfiConverterOptionTypeLspInformation.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_fetch_lsp_info(self.uniffiClonePointer(),
        FfiConverterString.lower(lspId),$0
    )
})
}
    
open func fetchReverseSwapFees(req: ReverseSwapFeesRequest)throws  -> ReverseSwapPairInfo {
    return try  FfiConverterTypeReverseSwapPairInfo.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_fetch_reverse_swap_fees(self.uniffiClonePointer(),
...
open func generateDiagnosticData()throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_generate_diagnostic_data(self.uniffiClonePointer(),$0
    )
})
}
    
open func inProgressOnchainPayments()throws  -> [ReverseSwapInfo] {
    return try  FfiConverterSequenceTypeReverseSwapInfo.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_in_progress_onchain_payments(self.uniffiClonePointer(),$0
    )
})
}
    
open func inProgressSwap()throws  -> SwapInfo? {
    return try  FfiConverterOptionTypeSwapInfo.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_in_progress_swap(self.uniffiClonePointer(),$0
    )
})
}
...
open func listFiatCurrencies()throws  -> [FiatCurrency] {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_list_fiat_currencies(self.uniffiClonePointer(),$0
    )
})
}
    
open func listLsps()throws  -> [LspInformation] {
    return try  FfiConverterSequenceTypeLspInformation.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_list_lsps(self.uniffiClonePointer(),$0
    )
})
}
    
open func listPayments(req: ListPaymentsRequest)throws  -> [Payment] {
    return try  FfiConverterSequenceTypePayment.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_list_payments(self.uniffiClonePointer(),
        FfiConverterTypeListPaymentsRequest.lower(req),$0
    )
})
}
    
open func listRefundables()throws  -> [SwapInfo] {
    return try  FfiConverterSequenceTypeSwapInfo.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_list_refundables(self.uniffiClonePointer(),$0
    )
})
}
    
open func listSwaps(req: ListSwapsRequest)throws  -> [SwapInfo] {
    return try  FfiConverterSequenceTypeSwapInfo.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_list_swaps(self.uniffiClonePointer(),
        FfiConverterTypeListSwapsRequest.lower(req),$0
    )
})
}
...
open func lnurlAuth(reqData: LnUrlAuthRequestData)throws  -> LnUrlCallbackStatus {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_lnurl_auth(self.uniffiClonePointer(),
        FfiConverterTypeLnUrlAuthRequestData.lower(reqData),$0
    )
})
}
    
open func lspId()throws  -> String? {
    return try  FfiConverterOptionString.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_lsp_id(self.uniffiClonePointer(),$0
    )
})
}
    
open func lspInfo()throws  -> LspInformation {
    return try  FfiConverterTypeLspInformation.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_lsp_info(self.uniffiClonePointer(),$0
    )
})
}
    
open func nodeCredentials()throws  -> NodeCredentials? {
    return try  FfiConverterOptionTypeNodeCredentials.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_node_credentials(self.uniffiClonePointer(),$0
    )
})
}
    
open func nodeInfo()throws  -> NodeState {
    return try  FfiConverterTypeNodeState.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_node_info(self.uniffiClonePointer(),$0
    )
})
}
    
open func onchainPaymentLimits()throws  -> OnchainPaymentLimitsResponse {
    return try  FfiConverterTypeOnchainPaymentLimitsResponse.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_onchain_payment_limits(self.uniffiClonePointer(),$0
    )
})
}
    
open func openChannelFee(req: OpenChannelFeeRequest)throws  -> OpenChannelFeeResponse {
    return try  FfiConverterTypeOpenChannelFeeResponse.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_open_channel_fee(self.uniffiClonePointer(),
        FfiConverterTypeOpenChannelFeeRequest.lower(req),$0
    )
})
}
    
open func payLnurl(req: LnUrlPayRequest)throws  -> LnUrlPayResult {
    return try  FfiConverterTypeLnUrlPayResult.lift(try rustCallWithError(FfiConverterTypeLnUrlPayError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_pay_lnurl(self.uniffiClonePointer(),
        FfiConverterTypeLnUrlPayRequest.lower(req),$0
    )
})
}
    
open func payOnchain(req: PayOnchainRequest)throws  -> PayOnchainResponse {
    return try  FfiConverterTypePayOnchainResponse.lift(try rustCallWithError(FfiConverterTypeSendOnchainError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_pay_onchain(self.uniffiClonePointer(),
        FfiConverterTypePayOnchainRequest.lower(req),$0
    )
})
}
    
open func paymentByHash(hash: String)throws  -> Payment? {
    return try  FfiConverterOptionTypePayment.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_payment_by_hash(self.uniffiClonePointer(),
        FfiConverterString.lower(hash),$0
    )
})
}
    
open func prepareOnchainPayment(req: PrepareOnchainPaymentRequest)throws  -> PrepareOnchainPaymentResponse {
    return try  FfiConverterTypePrepareOnchainPaymentResponse.lift(try rustCallWithError(FfiConverterTypeSendOnchainError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_prepare_onchain_payment(self.uniffiClonePointer(),
        FfiConverterTypePrepareOnchainPaymentRequest.lower(req),$0
    )
})
}
    
open func prepareRedeemOnchainFunds(req: PrepareRedeemOnchainFundsRequest)throws  -> PrepareRedeemOnchainFundsResponse {
    return try  FfiConverterTypePrepareRedeemOnchainFundsResponse.lift(try rustCallWithError(FfiConverterTypeRedeemOnchainError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_prepare_redeem_onchain_funds(self.uniffiClonePointer(),
...
open func prepareRefund(req: PrepareRefundRequest)throws  -> PrepareRefundResponse {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_prepare_refund(self.uniffiClonePointer(),
        FfiConverterTypePrepareRefundRequest.lower(req),$0
    )
})
}
    
open func receiveOnchain(req: ReceiveOnchainRequest)throws  -> SwapInfo {
    return try  FfiConverterTypeSwapInfo.lift(try rustCallWithError(FfiConverterTypeReceiveOnchainError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_receive_onchain(self.uniffiClonePointer(),
...
open func receivePayment(req: ReceivePaymentRequest)throws  -> ReceivePaymentResponse {
    return try  FfiConverterTypeReceivePaymentResponse.lift(try rustCallWithError(FfiConverterTypeReceivePaymentError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_receive_payment(self.uniffiClonePointer(),
...
open func recommendedFees()throws  -> RecommendedFees {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_recommended_fees(self.uniffiClonePointer(),$0
    )
})
}
    
open func redeemOnchainFunds(req: RedeemOnchainFundsRequest)throws  -> RedeemOnchainFundsResponse {
    return try  FfiConverterTypeRedeemOnchainFundsResponse.lift(try rustCallWithError(FfiConverterTypeRedeemOnchainError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_redeem_onchain_funds(self.uniffiClonePointer(),
        FfiConverterTypeRedeemOnchainFundsRequest.lower(req),$0
    )
})
}
    
open func redeemSwap(swapAddress: String)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_redeem_swap(self.uniffiClonePointer(),
...
open func refund(req: RefundRequest)throws  -> RefundResponse {
    return try  FfiConverterTypeRefundResponse.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_refund(self.uniffiClonePointer(),
...
open func registerWebhook(webhookUrl: String)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_register_webhook(self.uniffiClonePointer(),
        FfiConverterString.lower(webhookUrl),$0
    )
}
}
    
open func reportIssue(req: ReportIssueRequest)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_report_issue(self.uniffiClonePointer(),
        FfiConverterTypeReportIssueRequest.lower(req),$0
    )
}
}
    
open func rescanSwaps()throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_rescan_swaps(self.uniffiClonePointer(),$0
    )
}
}
    
open func sendPayment(req: SendPaymentRequest)throws  -> SendPaymentResponse {
    return try  FfiConverterTypeSendPaymentResponse.lift(try rustCallWithError(FfiConverterTypeSendPaymentError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_send_payment(self.uniffiClonePointer(),
        FfiConverterTypeSendPaymentRequest.lower(req),$0
    )
})
}
    
open func sendSpontaneousPayment(req: SendSpontaneousPaymentRequest)throws  -> SendPaymentResponse {
    return try  FfiConverterTypeSendPaymentResponse.lift(try rustCallWithError(FfiConverterTypeSendPaymentError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_send_spontaneous_payment(self.uniffiClonePointer(),
        FfiConverterTypeSendSpontaneousPaymentRequest.lower(req),$0
    )
})
}
    
open func setPaymentMetadata(hash: String, metadata: String)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_set_payment_metadata(self.uniffiClonePointer(),
...
open func signMessage(req: SignMessageRequest)throws  -> SignMessageResponse {
    ...
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_sign_message(self.uniffiClonePointer(),
...
open func sync()throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_sync(self.uniffiClonePointer(),$0
    )
}
}
    
open func unregisterWebhook(webhookUrl: String)throws  {try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_unregister_webhook(self.uniffiClonePointer(),
        FfiConverterString.lower(webhookUrl),$0
    )
}
}
    
open func withdrawLnurl(request: LnUrlWithdrawRequest)throws  -> LnUrlWithdrawResult {
    return try  FfiConverterTypeLnUrlWithdrawResult.lift(try rustCallWithError(FfiConverterTypeLnUrlWithdrawError.lift) {
    uniffi_breez_sdk_bindings_fn_method_blockingbreezservices_withdraw_lnurl(self.uniffiClonePointer(),
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBlockingBreezServices_lift(_ pointer: UnsafeMutableRawPointer) throws -> BlockingBreezServices {
    return try FfiConverterTypeBlockingBreezServices.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeBlockingBreezServices_lower(_ value: BlockingBreezServices) -> UnsafeMutableRawPointer {
    return FfiConverterTypeBlockingBreezServices.lower(value)
}
...
public struct BuyBitcoinRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(provider: BuyBitcoinProvider, openingFeeParams: OpeningFeeParams? = nil, redirectUrl: String? = nil) {
...
public struct ClosedChannelPaymentDetails {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(state: ChannelState, fundingTxid: String, shortChannelId: String?, closingTxid: String?) {
        self.state = state
...
public struct FfiConverterTypeClosedChannelPaymentDetails: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ClosedChannelPaymentDetails {
        return
            try ClosedChannelPaymentDetails(
...
public struct Config {
    ...
    public var chainnotifierUrl: String
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(breezserver: String, chainnotifierUrl: String, mempoolspaceUrl: String?, workingDir: String, network: Network, paymentTimeoutSec: UInt32, defaultLspId: String?, apiKey: String?, maxfeePercent: Double, exemptfeeMsat: UInt64, nodeConfig: NodeConfig) {
        self.breezserver = breezserver
        self.chainnotifierUrl = chainnotifierUrl
...
extension Config: Equatable, Hashable {
    public static func ==(lhs: Config, rhs: Config) -> Bool {
        ...
        if lhs.chainnotifierUrl != rhs.chainnotifierUrl {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(chainnotifierUrl)
...
public struct FfiConverterTypeConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Config {
        return
            try Config(
                ...
                chainnotifierUrl: FfiConverterString.read(from: &buf), 
                mempoolspaceUrl: FfiConverterOptionString.read(from: &buf), 
    ...
    public static func write(_ value: Config, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.chainnotifierUrl, into: &buf)
        FfiConverterOptionString.write(value.mempoolspaceUrl, into: &buf)
...
public struct ConfigureNodeRequest {
    public var closeToAddress: String?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(closeToAddress: String?) {
        self.closeToAddress = closeToAddress
    }
}



extension ConfigureNodeRequest: Equatable, Hashable {
    public static func ==(lhs: ConfigureNodeRequest, rhs: ConfigureNodeRequest) -> Bool {
        if lhs.closeToAddress != rhs.closeToAddress {
            return false
        }
        return true
    }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeConfigureNodeRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ConfigureNodeRequest {
        return
            try ConfigureNodeRequest(
                closeToAddress: FfiConverterOptionString.read(from: &buf)
        )
    }

    public static func write(_ value: ConfigureNodeRequest, into buf: inout [UInt8]) {
        FfiConverterOptionString.write(value.closeToAddress, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeConfigureNodeRequest_lift(_ buf: RustBuffer) throws -> ConfigureNodeRequest {
    return try FfiConverterTypeConfigureNodeRequest.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeConfigureNodeRequest_lower(_ value: ConfigureNodeRequest) -> RustBuffer {
    return FfiConverterTypeConfigureNodeRequest.lower(value)
}
...
public struct ConnectRequest {
    ...
    public var restoreOnly: Bool?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(config: Config, seed: [UInt8], restoreOnly: Bool? = nil) {
        self.config = config
        self.seed = seed
...
extension ConnectRequest: Equatable, Hashable {
    public static func ==(lhs: ConnectRequest, rhs: ConnectRequest) -> Bool {
        ...
        if lhs.restoreOnly != rhs.restoreOnly {
            return false
        }
        return true
    }
...
public struct FfiConverterTypeConnectRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ConnectRequest {
        return
            try ConnectRequest(
                ...
                restoreOnly: FfiConverterOptionBool.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: ConnectRequest, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionBool.write(value.restoreOnly, into: &buf)
    }
}
...
public struct FfiConverterTypeGreenlightDeviceCredentials: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> GreenlightDeviceCredentials {
        return
            try GreenlightDeviceCredentials(
...
public struct ListPaymentsRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(filters: [PaymentTypeFilter]? = nil, metadataFilters: [MetadataFilter]? = nil, fromTimestamp: Int64? = nil, toTimestamp: Int64? = nil, includeFailures: Bool? = nil, offset: UInt32? = nil, limit: UInt32? = nil) {
...
extension ListPaymentsRequest: Equatable, Hashable {
    public static func ==(lhs: ListPaymentsRequest, rhs: ListPaymentsRequest) -> Bool {
        ...
        if lhs.metadataFilters != rhs.metadataFilters {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(metadataFilters)
...
public struct FfiConverterTypeListPaymentsRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ListPaymentsRequest {
        return
            try ListPaymentsRequest(
                ...
                metadataFilters: FfiConverterOptionSequenceTypeMetadataFilter.read(from: &buf), 
    ...
    public static func write(_ value: ListPaymentsRequest, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionSequenceTypeMetadataFilter.write(value.metadataFilters, into: &buf)
...
public struct ListSwapsRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(status: [SwapStatus]? = nil, fromTimestamp: Int64? = nil, toTimestamp: Int64? = nil, offset: UInt32? = nil, limit: UInt32? = nil) {
        self.status = status
        self.fromTimestamp = fromTimestamp
        self.toTimestamp = toTimestamp
        self.offset = offset
...
extension ListSwapsRequest: Equatable, Hashable {
    public static func ==(lhs: ListSwapsRequest, rhs: ListSwapsRequest) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeListSwapsRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ListSwapsRequest {
        return
            try ListSwapsRequest(
                status: FfiConverterOptionSequenceTypeSwapStatus.read(from: &buf), 
                fromTimestamp: FfiConverterOptionInt64.read(from: &buf), 
                toTimestamp: FfiConverterOptionInt64.read(from: &buf), 
                offset: FfiConverterOptionUInt32.read(from: &buf), 
                limit: FfiConverterOptionUInt32.read(from: &buf)
    ...
    public static func write(_ value: ListSwapsRequest, into buf: inout [UInt8]) {
        FfiConverterOptionSequenceTypeSwapStatus.write(value.status, into: &buf)
        FfiConverterOptionInt64.write(value.fromTimestamp, into: &buf)
        FfiConverterOptionInt64.write(value.toTimestamp, into: &buf)
        FfiConverterOptionUInt32.write(value.offset, into: &buf)
        FfiConverterOptionUInt32.write(value.limit, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeListSwapsRequest_lift(_ buf: RustBuffer) throws -> ListSwapsRequest {
    return try FfiConverterTypeListSwapsRequest.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeListSwapsRequest_lower(_ value: ListSwapsRequest) -> RustBuffer {
    return FfiConverterTypeListSwapsRequest.lower(value)
}
...
public struct LnPaymentDetails {
    ...
    public var bolt11: String
    public var openChannelBolt11: String?
    ...
    public var pendingExpirationBlock: UInt32?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(paymentHash: String, label: String, destinationPubkey: String, paymentPreimage: String, keysend: Bool, bolt11: String, openChannelBolt11: String?, lnurlSuccessAction: SuccessActionProcessed?, lnurlPayDomain: String?, lnurlPayComment: String?, lnurlMetadata: String?, lnAddress: String?, lnurlWithdrawEndpoint: String?, swapInfo: SwapInfo?, reverseSwapInfo: ReverseSwapInfo?, pendingExpirationBlock: UInt32?) {
        self.paymentHash = paymentHash
        self.label = label
        ...
        self.bolt11 = bolt11
        self.openChannelBolt11 = openChannelBolt11
        ...
        self.pendingExpirationBlock = pendingExpirationBlock
    }
}
...
extension LnPaymentDetails: Equatable, Hashable {
    public static func ==(lhs: LnPaymentDetails, rhs: LnPaymentDetails) -> Bool {
        ...
        if lhs.openChannelBolt11 != rhs.openChannelBolt11 {
            return false
        }
        ...
        if lhs.pendingExpirationBlock != rhs.pendingExpirationBlock {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(bolt11)
        hasher.combine(openChannelBolt11)
        ...
        hasher.combine(pendingExpirationBlock)
    }
}
...
public struct FfiConverterTypeLnPaymentDetails: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LnPaymentDetails {
        return
            try LnPaymentDetails(
                ...
                bolt11: FfiConverterString.read(from: &buf), 
                openChannelBolt11: FfiConverterOptionString.read(from: &buf), 
                ...
                reverseSwapInfo: FfiConverterOptionTypeReverseSwapInfo.read(from: &buf), 
                pendingExpirationBlock: FfiConverterOptionUInt32.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: LnPaymentDetails, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.bolt11, into: &buf)
        FfiConverterOptionString.write(value.openChannelBolt11, into: &buf)
        ...
        FfiConverterOptionTypeReverseSwapInfo.write(value.reverseSwapInfo, into: &buf)
        FfiConverterOptionUInt32.write(value.pendingExpirationBlock, into: &buf)
    }
}
...
public struct LnUrlPayRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(data: LnUrlPayRequestData, amountMsat: UInt64, useTrampoline: Bool, comment: String? = nil, paymentLabel: String? = nil, validateSuccessActionUrl: Bool? = nil) {
        self.data = data
        self.amountMsat = amountMsat
        self.useTrampoline = useTrampoline
...
extension LnUrlPayRequest: Equatable, Hashable {
    public static func ==(lhs: LnUrlPayRequest, rhs: LnUrlPayRequest) -> Bool {
        ...
        if lhs.useTrampoline != rhs.useTrampoline {
            return false
        }
...
public struct FfiConverterTypeLnUrlPayRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LnUrlPayRequest {
        return
            try LnUrlPayRequest(
                ...
                useTrampoline: FfiConverterBool.read(from: &buf), 
    ...
    public static func write(_ value: LnUrlPayRequest, into buf: inout [UInt8]) {
        ...
        FfiConverterBool.write(value.useTrampoline, into: &buf)
...
public struct LspInformation {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: String, name: String, widgetUrl: String, pubkey: String, host: String, baseFeeMsat: Int64, feeRate: Double, timeLockDelta: UInt32, minHtlcMsat: Int64, lspPubkey: [UInt8], openingFeeParamsList: OpeningFeeParamsMenu) {
        self.id = id
        self.name = name
...
public struct MetadataFilter {
    public var jsonPath: String
    public var jsonValue: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(jsonPath: String, jsonValue: String) {
...
extension MetadataFilter: Equatable, Hashable {
    public static func ==(lhs: MetadataFilter, rhs: MetadataFilter) -> Bool {
        if lhs.jsonPath != rhs.jsonPath {
            return false
        }
        if lhs.jsonValue != rhs.jsonValue {
            return false
        }
        return true
    }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMetadataFilter: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MetadataFilter {
        return
            try MetadataFilter(
                jsonPath: FfiConverterString.read(from: &buf), 
                jsonValue: FfiConverterString.read(from: &buf)
        )
    }

    public static func write(_ value: MetadataFilter, into buf: inout [UInt8]) {
        FfiConverterString.write(value.jsonPath, into: &buf)
        FfiConverterString.write(value.jsonValue, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMetadataFilter_lift(_ buf: RustBuffer) throws -> MetadataFilter {
    return try FfiConverterTypeMetadataFilter.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMetadataFilter_lower(_ value: MetadataFilter) -> RustBuffer {
    return FfiConverterTypeMetadataFilter.lower(value)
}
...
public struct NodeState {
    ...
    public var maxReceivableSinglePaymentAmountMsat: UInt64
    public var totalInboundLiquidityMsats: UInt64

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: String, blockHeight: UInt32, channelsBalanceMsat: UInt64, onchainBalanceMsat: UInt64, pendingOnchainBalanceMsat: UInt64, utxos: [UnspentTransactionOutput], maxPayableMsat: UInt64, maxReceivableMsat: UInt64, maxSinglePaymentAmountMsat: UInt64, maxChanReserveMsats: UInt64, connectedPeers: [String], maxReceivableSinglePaymentAmountMsat: UInt64, totalInboundLiquidityMsats: UInt64) {
        self.id = id
        ...
        self.maxReceivableSinglePaymentAmountMsat = maxReceivableSinglePaymentAmountMsat
        self.totalInboundLiquidityMsats = totalInboundLiquidityMsats
    }
}
...
extension NodeState: Equatable, Hashable {
    public static func ==(lhs: NodeState, rhs: NodeState) -> Bool {
        ...
        if lhs.maxReceivableSinglePaymentAmountMsat != rhs.maxReceivableSinglePaymentAmountMsat {
            return false
        }
        if lhs.totalInboundLiquidityMsats != rhs.totalInboundLiquidityMsats {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(maxReceivableSinglePaymentAmountMsat)
        hasher.combine(totalInboundLiquidityMsats)
    }
}
...
public struct FfiConverterTypeNodeState: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NodeState {
        return
            try NodeState(
                ...
                maxReceivableSinglePaymentAmountMsat: FfiConverterUInt64.read(from: &buf), 
                totalInboundLiquidityMsats: FfiConverterUInt64.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: NodeState, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.maxReceivableSinglePaymentAmountMsat, into: &buf)
        FfiConverterUInt64.write(value.totalInboundLiquidityMsats, into: &buf)
    }
}
...
public struct OnchainPaymentLimitsResponse {
    ...
    public var maxPayableSat: UInt64

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(minSat: UInt64, maxSat: UInt64, maxPayableSat: UInt64) {
        self.minSat = minSat
        self.maxSat = maxSat
        self.maxPayableSat = maxPayableSat
    }
}
...
extension OnchainPaymentLimitsResponse: Equatable, Hashable {
    public static func ==(lhs: OnchainPaymentLimitsResponse, rhs: OnchainPaymentLimitsResponse) -> Bool {
        ...
        if lhs.maxPayableSat != rhs.maxPayableSat {
            return false
        }
        return true
    }
...
public struct FfiConverterTypeOnchainPaymentLimitsResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> OnchainPaymentLimitsResponse {
        return
            try OnchainPaymentLimitsResponse(
                ...
                maxPayableSat: FfiConverterUInt64.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: OnchainPaymentLimitsResponse, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.maxPayableSat, into: &buf)
    }
}
...
public struct OpenChannelFeeResponse {
    ...
    public var feeParams: OpeningFeeParams

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(feeMsat: UInt64?, feeParams: OpeningFeeParams) {
...
extension OpenChannelFeeResponse: Equatable, Hashable {
    public static func ==(lhs: OpenChannelFeeResponse, rhs: OpenChannelFeeResponse) -> Bool {
        ...
        if lhs.feeParams != rhs.feeParams {
            return false
        }
        return true
    }
...
public struct FfiConverterTypeOpenChannelFeeResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> OpenChannelFeeResponse {
        return
            try OpenChannelFeeResponse(
                feeMsat: FfiConverterOptionUInt64.read(from: &buf), 
                feeParams: FfiConverterTypeOpeningFeeParams.read(from: &buf)
        )
    }

    public static func write(_ value: OpenChannelFeeResponse, into buf: inout [UInt8]) {
        FfiConverterOptionUInt64.write(value.feeMsat, into: &buf)
        FfiConverterTypeOpeningFeeParams.write(value.feeParams, into: &buf)
    }
}
...
public struct PayOnchainRequest {
    ...
    public var prepareRes: PrepareOnchainPaymentResponse

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(recipientAddress: String, prepareRes: PrepareOnchainPaymentResponse) {
...
public struct FfiConverterTypePayOnchainRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PayOnchainRequest {
        return
            try PayOnchainRequest(
                ...
                prepareRes: FfiConverterTypePrepareOnchainPaymentResponse.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: PayOnchainRequest, into buf: inout [UInt8]) {
        ...
        FfiConverterTypePrepareOnchainPaymentResponse.write(value.prepareRes, into: &buf)
    }
}
...
public struct Payment {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: String, paymentType: PaymentType, paymentTime: Int64, amountMsat: UInt64, feeMsat: UInt64, status: PaymentStatus, error: String?, description: String?, details: PaymentDetails, metadata: String?) {
        self.id = id
...
public struct PaymentFailedData {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(error: String, nodeId: String, invoice: LnInvoice?, label: String?) {
        self.error = error
        self.nodeId = nodeId
        self.invoice = invoice
        self.label = label
...
public struct PrepareOnchainPaymentRequest {
    public var amountSat: UInt64
    public var amountType: SwapAmountType
    public var claimTxFeerate: UInt32

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(amountSat: UInt64, amountType: SwapAmountType, claimTxFeerate: UInt32) {
        self.amountSat = amountSat
        self.amountType = amountType
        self.claimTxFeerate = claimTxFeerate
    }
}



extension PrepareOnchainPaymentRequest: Equatable, Hashable {
    public static func ==(lhs: PrepareOnchainPaymentRequest, rhs: PrepareOnchainPaymentRequest) -> Bool {
        if lhs.amountSat != rhs.amountSat {
            return false
        }
        if lhs.amountType != rhs.amountType {
            return false
        }
        if lhs.claimTxFeerate != rhs.claimTxFeerate {
            return false
        }
        return true
    }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePrepareOnchainPaymentRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PrepareOnchainPaymentRequest {
        return
            try PrepareOnchainPaymentRequest(
                amountSat: FfiConverterUInt64.read(from: &buf), 
                amountType: FfiConverterTypeSwapAmountType.read(from: &buf), 
                claimTxFeerate: FfiConverterUInt32.read(from: &buf)
        )
    }

    public static func write(_ value: PrepareOnchainPaymentRequest, into buf: inout [UInt8]) {
        FfiConverterUInt64.write(value.amountSat, into: &buf)
        FfiConverterTypeSwapAmountType.write(value.amountType, into: &buf)
        FfiConverterUInt32.write(value.claimTxFeerate, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePrepareOnchainPaymentRequest_lift(_ buf: RustBuffer) throws -> PrepareOnchainPaymentRequest {
    return try FfiConverterTypePrepareOnchainPaymentRequest.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePrepareOnchainPaymentRequest_lower(_ value: PrepareOnchainPaymentRequest) -> RustBuffer {
    return FfiConverterTypePrepareOnchainPaymentRequest.lower(value)
}
...
public struct PrepareRedeemOnchainFundsRequest {
...
extension PrepareRedeemOnchainFundsRequest: Equatable, Hashable {
    public static func ==(lhs: PrepareRedeemOnchainFundsRequest, rhs: PrepareRedeemOnchainFundsRequest) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePrepareRedeemOnchainFundsRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PrepareRedeemOnchainFundsRequest {
        return
            try PrepareRedeemOnchainFundsRequest(
                toAddress: FfiConverterString.read(from: &buf), 
                satPerVbyte: FfiConverterUInt32.read(from: &buf)
        )
    }

    public static func write(_ value: PrepareRedeemOnchainFundsRequest, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePrepareRedeemOnchainFundsRequest_lift(_ buf: RustBuffer) throws -> PrepareRedeemOnchainFundsRequest {
    return try FfiConverterTypePrepareRedeemOnchainFundsRequest.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePrepareRedeemOnchainFundsRequest_lower(_ value: PrepareRedeemOnchainFundsRequest) -> RustBuffer {
    return FfiConverterTypePrepareRedeemOnchainFundsRequest.lower(value)
}


public struct PrepareRedeemOnchainFundsResponse {
    public var txWeight: UInt64
    public var txFeeSat: UInt64

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(txWeight: UInt64, txFeeSat: UInt64) {
        self.txWeight = txWeight
...
extension PrepareRedeemOnchainFundsResponse: Equatable, Hashable {
    public static func ==(lhs: PrepareRedeemOnchainFundsResponse, rhs: PrepareRedeemOnchainFundsResponse) -> Bool {
        if lhs.txWeight != rhs.txWeight {
            return false
        }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePrepareRedeemOnchainFundsResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PrepareRedeemOnchainFundsResponse {
        return
            try PrepareRedeemOnchainFundsResponse(
                txWeight: FfiConverterUInt64.read(from: &buf), 
                txFeeSat: FfiConverterUInt64.read(from: &buf)
        )
    }

    public static func write(_ value: PrepareRedeemOnchainFundsResponse, into buf: inout [UInt8]) {
        FfiConverterUInt64.write(value.txWeight, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePrepareRedeemOnchainFundsResponse_lift(_ buf: RustBuffer) throws -> PrepareRedeemOnchainFundsResponse {
    return try FfiConverterTypePrepareRedeemOnchainFundsResponse.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePrepareRedeemOnchainFundsResponse_lower(_ value: PrepareRedeemOnchainFundsResponse) -> RustBuffer {
    return FfiConverterTypePrepareRedeemOnchainFundsResponse.lower(value)
}
...
public struct PrepareRefundRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(swapAddress: String, toAddress: String, satPerVbyte: UInt32, unilateral: Bool? = nil) {
...
extension PrepareRefundRequest: Equatable, Hashable {
    public static func ==(lhs: PrepareRefundRequest, rhs: PrepareRefundRequest) -> Bool {
        ...
        if lhs.unilateral != rhs.unilateral {
            return false
        }
        return true
    }
...
public struct FfiConverterTypePrepareRefundRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PrepareRefundRequest {
        return
            try PrepareRefundRequest(
                ...
                toAddress: FfiConverterString.read(from: &buf), 
                satPerVbyte: FfiConverterUInt32.read(from: &buf), 
                unilateral: FfiConverterOptionBool.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: PrepareRefundRequest, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.toAddress, into: &buf)
        FfiConverterUInt32.write(value.satPerVbyte, into: &buf)
        FfiConverterOptionBool.write(value.unilateral, into: &buf)
    }
}
...
public struct RedeemOnchainFundsRequest {
    public var toAddress: String
    public var satPerVbyte: UInt32
...
extension RedeemOnchainFundsRequest: Equatable, Hashable {
    public static func ==(lhs: RedeemOnchainFundsRequest, rhs: RedeemOnchainFundsRequest) -> Bool {
        if lhs.toAddress != rhs.toAddress {
            return false
        }
        if lhs.satPerVbyte != rhs.satPerVbyte {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRedeemOnchainFundsRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RedeemOnchainFundsRequest {
        return
            try RedeemOnchainFundsRequest(
                toAddress: FfiConverterString.read(from: &buf), 
                satPerVbyte: FfiConverterUInt32.read(from: &buf)
        )
    }

    public static func write(_ value: RedeemOnchainFundsRequest, into buf: inout [UInt8]) {
        FfiConverterString.write(value.toAddress, into: &buf)
        FfiConverterUInt32.write(value.satPerVbyte, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRedeemOnchainFundsRequest_lift(_ buf: RustBuffer) throws -> RedeemOnchainFundsRequest {
    return try FfiConverterTypeRedeemOnchainFundsRequest.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRedeemOnchainFundsRequest_lower(_ value: RedeemOnchainFundsRequest) -> RustBuffer {
    return FfiConverterTypeRedeemOnchainFundsRequest.lower(value)
}


public struct RedeemOnchainFundsResponse {
...
extension RedeemOnchainFundsResponse: Equatable, Hashable {
    public static func ==(lhs: RedeemOnchainFundsResponse, rhs: RedeemOnchainFundsResponse) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRedeemOnchainFundsResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RedeemOnchainFundsResponse {
        return
            try RedeemOnchainFundsResponse(
                txid: FfiConverterSequenceUInt8.read(from: &buf)
        )
    }

    public static func write(_ value: RedeemOnchainFundsResponse, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRedeemOnchainFundsResponse_lift(_ buf: RustBuffer) throws -> RedeemOnchainFundsResponse {
    return try FfiConverterTypeRedeemOnchainFundsResponse.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRedeemOnchainFundsResponse_lower(_ value: RedeemOnchainFundsResponse) -> RustBuffer {
    return FfiConverterTypeRedeemOnchainFundsResponse.lower(value)
}
...
public struct FfiConverterTypeReportPaymentFailureDetails: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ReportPaymentFailureDetails {
        return
            try ReportPaymentFailureDetails(
                paymentHash: FfiConverterString.read(from: &buf), 
                comment: FfiConverterOptionString.read(from: &buf)
        )
    }
...
public struct ReverseSwapFeesRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(sendAmountSat: UInt64? = nil, claimTxFeerate: UInt32? = nil) {
...
public struct FfiConverterTypeReverseSwapFeesRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ReverseSwapFeesRequest {
        return
            try ReverseSwapFeesRequest(
                sendAmountSat: FfiConverterOptionUInt64.read(from: &buf), 
                claimTxFeerate: FfiConverterOptionUInt32.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: ReverseSwapFeesRequest, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionUInt32.write(value.claimTxFeerate, into: &buf)
    }
}
...
public struct ReverseSwapPairInfo {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(min: UInt64, max: UInt64, feesHash: String, feesPercentage: Double, feesLockup: UInt64, feesClaim: UInt64, totalFees: UInt64?) {
        self.min = min
        self.max = max
        self.feesHash = feesHash
        self.feesPercentage = feesPercentage
...
public struct FfiConverterTypeReverseSwapPairInfo: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ReverseSwapPairInfo {
        return
            try ReverseSwapPairInfo(
                ...
                feesLockup: FfiConverterUInt64.read(from: &buf), 
                feesClaim: FfiConverterUInt64.read(from: &buf), 
                totalFees: FfiConverterOptionUInt64.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: ReverseSwapPairInfo, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.feesLockup, into: &buf)
        FfiConverterUInt64.write(value.feesClaim, into: &buf)
        FfiConverterOptionUInt64.write(value.totalFees, into: &buf)
    }
}
...
public struct SendPaymentRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(bolt11: String, useTrampoline: Bool, amountMsat: UInt64? = nil, label: String? = nil) {
        self.bolt11 = bolt11
        self.useTrampoline = useTrampoline
        self.amountMsat = amountMsat
        self.label = label
...
public struct SendSpontaneousPaymentRequest {
    public var nodeId: String
    public var amountMsat: UInt64
    public var extraTlvs: [TlvEntry]?
    public var label: String?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(nodeId: String, amountMsat: UInt64, extraTlvs: [TlvEntry]? = nil, label: String? = nil) {
        self.nodeId = nodeId
        self.amountMsat = amountMsat
        self.extraTlvs = extraTlvs
        self.label = label
    }
}
...
extension SendSpontaneousPaymentRequest: Equatable, Hashable {
    public static func ==(lhs: SendSpontaneousPaymentRequest, rhs: SendSpontaneousPaymentRequest) -> Bool {
        ...
        if lhs.extraTlvs != rhs.extraTlvs {
            return false
        }
        if lhs.label != rhs.label {
            return false
...
public struct FfiConverterTypeSendSpontaneousPaymentRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SendSpontaneousPaymentRequest {
        return
            try SendSpontaneousPaymentRequest(
                nodeId: FfiConverterString.read(from: &buf), 
                amountMsat: FfiConverterUInt64.read(from: &buf), 
                extraTlvs: FfiConverterOptionSequenceTypeTlvEntry.read(from: &buf), 
                label: FfiConverterOptionString.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: SendSpontaneousPaymentRequest, into buf: inout [UInt8]) {
        FfiConverterString.write(value.nodeId, into: &buf)
        FfiConverterUInt64.write(value.amountMsat, into: &buf)
        FfiConverterOptionSequenceTypeTlvEntry.write(value.extraTlvs, into: &buf)
        FfiConverterOptionString.write(value.label, into: &buf)
    }
}
...
public struct FfiConverterTypeServiceHealthCheckResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ServiceHealthCheckResponse {
        return
            try ServiceHealthCheckResponse(
...
public struct SwapInfo {
    ...
    public var totalIncomingTxs: UInt64
    public var status: SwapStatus
    ...
    public var maxSwapperPayable: Int64
    public var lastRedeemError: String?
    public var channelOpeningFees: OpeningFeeParams?
    public var confirmedAt: UInt32?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(bitcoinAddress: String, createdAt: Int64, lockHeight: Int64, paymentHash: [UInt8], preimage: [UInt8], privateKey: [UInt8], publicKey: [UInt8], swapperPublicKey: [UInt8], script: [UInt8], bolt11: String?, paidMsat: UInt64, unconfirmedSats: UInt64, confirmedSats: UInt64, totalIncomingTxs: UInt64, status: SwapStatus, refundTxIds: [String], unconfirmedTxIds: [String], confirmedTxIds: [String], minAllowedDeposit: Int64, maxAllowedDeposit: Int64, maxSwapperPayable: Int64, lastRedeemError: String?, channelOpeningFees: OpeningFeeParams?, confirmedAt: UInt32?) {
        ...
        self.totalIncomingTxs = totalIncomingTxs
        self.status = status
        ...
        self.maxSwapperPayable = maxSwapperPayable
...
extension SwapInfo: Equatable, Hashable {
    public static func ==(lhs: SwapInfo, rhs: SwapInfo) -> Bool {
        ...
        if lhs.totalIncomingTxs != rhs.totalIncomingTxs {
            return false
        }
        if lhs.status != rhs.status {
            return false
        ...
        if lhs.maxSwapperPayable != rhs.maxSwapperPayable {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(totalIncomingTxs)
        hasher.combine(status)
...
public struct FfiConverterTypeSwapInfo: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwapInfo {
        return
            try SwapInfo(
                ...
                totalIncomingTxs: FfiConverterUInt64.read(from: &buf), 
                ...
                maxSwapperPayable: FfiConverterInt64.read(from: &buf), 
                ...
                confirmedAt: FfiConverterOptionUInt32.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: SwapInfo, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.totalIncomingTxs, into: &buf)
        ...
        FfiConverterInt64.write(value.maxSwapperPayable, into: &buf)
        ...
        FfiConverterOptionUInt32.write(value.confirmedAt, into: &buf)
    }
}
...
public struct TlvEntry {
    public var fieldNumber: UInt64
    public var value: [UInt8]

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(fieldNumber: UInt64, value: [UInt8]) {
...
extension TlvEntry: Equatable, Hashable {
    public static func ==(lhs: TlvEntry, rhs: TlvEntry) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeTlvEntry: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TlvEntry {
        return
            try TlvEntry(
                fieldNumber: FfiConverterUInt64.read(from: &buf), 
                value: FfiConverterSequenceUInt8.read(from: &buf)
        )
    }

    public static func write(_ value: TlvEntry, into buf: inout [UInt8]) {
        FfiConverterUInt64.write(value.fieldNumber, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTlvEntry_lift(_ buf: RustBuffer) throws -> TlvEntry {
    return try FfiConverterTypeTlvEntry.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTlvEntry_lower(_ value: TlvEntry) -> RustBuffer {
    return FfiConverterTypeTlvEntry.lower(value)
}
...
public enum BreezEvent {
    ...
    case reverseSwapUpdated(details: ReverseSwapInfo
    )
    case swapUpdated(details: SwapInfo
    )
}
...
public struct FfiConverterTypeBreezEvent: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BreezEvent {
        ...
        case 1: return .newBlock(block: try FfiConverterUInt32.read(from: &buf)
        )
        
        case 2: return .invoicePaid(details: try FfiConverterTypeInvoicePaidDetails.read(from: &buf)
        )
        
        case 3: return .synced
        
        case 4: return .paymentSucceed(details: try FfiConverterTypePayment.read(from: &buf)
        )
        
        case 5: return .paymentFailed(details: try FfiConverterTypePaymentFailedData.read(from: &buf)
        )
        ...
        case 8: return .backupFailed(details: try FfiConverterTypeBackupFailedData.read(from: &buf)
        )
        
        case 9: return .reverseSwapUpdated(details: try FfiConverterTypeReverseSwapInfo.read(from: &buf)
        )
        
        case 10: return .swapUpdated(details: try FfiConverterTypeSwapInfo.read(from: &buf)
        )
    ...
    public static func write(_ value: BreezEvent, into buf: inout [UInt8]) {
        ...
        case let .reverseSwapUpdated(details):
            writeInt(&buf, Int32(9))
            FfiConverterTypeReverseSwapInfo.write(details, into: &buf)
            
        
        case let .swapUpdated(details):
            writeInt(&buf, Int32(10))
            FfiConverterTypeSwapInfo.write(details, into: &buf)
...
public enum ConnectError {
    ...
    case RestoreOnly(message: String)
...
public struct FfiConverterTypeConnectError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: ConnectError, into buf: inout [UInt8]) {
        ...
        case .Generic(_ /* message is ignored*/):
            writeInt(&buf, Int32(1))
        case .RestoreOnly(_ /* message is ignored*/):
            writeInt(&buf, Int32(2))
...
public struct FfiConverterTypeInputType: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> InputType {
        ...
        case 5: return .lnUrlPay(data: try FfiConverterTypeLnUrlPayRequestData.read(from: &buf), bip353Address: try FfiConverterOptionString.read(from: &buf)
        )
...
public struct FfiConverterTypeLnUrlPayError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LnUrlPayError {
        ...
        case 13: return .InsufficientBalance(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: LnUrlPayError, into buf: inout [UInt8]) {
        ...
        case .InvalidUri(_ /* message is ignored*/):
            writeInt(&buf, Int32(6))
        case .InvoiceExpired(_ /* message is ignored*/):
            writeInt(&buf, Int32(7))
        ...
        case .RouteNotFound(_ /* message is ignored*/):
            writeInt(&buf, Int32(10))
        case .RouteTooExpensive(_ /* message is ignored*/):
...
public enum LnUrlWithdrawError {
    ...
    case InvoiceNoRoutingHints(message: String)
...
public struct FfiConverterTypeLnUrlWithdrawError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: LnUrlWithdrawError, into buf: inout [UInt8]) {
        ...
        case .ServiceConnectivity(_ /* message is ignored*/):
            writeInt(&buf, Int32(5))
        case .InvoiceNoRoutingHints(_ /* message is ignored*/):
            writeInt(&buf, Int32(6))
...
public struct FfiConverterTypeNodeConfig: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NodeConfig {
        ...
        case 1: return .greenlight(config: try FfiConverterTypeGreenlightNodeConfig.read(from: &buf)
        )
...
public struct FfiConverterTypeNodeCredentials: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NodeCredentials {
        ...
        case 1: return .greenlight(credentials: try FfiConverterTypeGreenlightDeviceCredentials.read(from: &buf)
        )
...
public struct FfiConverterTypePaymentDetails: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PaymentDetails {
        ...
        case 1: return .ln(data: try FfiConverterTypeLnPaymentDetails.read(from: &buf)
        )
        
        case 2: return .closedChannel(data: try FfiConverterTypeClosedChannelPaymentDetails.read(from: &buf)
        )
...
public struct FfiConverterTypeReceiveOnchainError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: ReceiveOnchainError, into buf: inout [UInt8]) {
        ...
        case .ServiceConnectivity(_ /* message is ignored*/):
            writeInt(&buf, Int32(2))
        case .SwapInProgress(_ /* message is ignored*/):
            writeInt(&buf, Int32(3))
...
extension ReceiveOnchainError: Foundation.LocalizedError {
    public var errorDescription: String? {
        String(reflecting: self)
    }
}
...
public struct FfiConverterTypeReceivePaymentError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ReceivePaymentError {
        ...
        case 8: return .InvoiceNoRoutingHints(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: ReceivePaymentError, into buf: inout [UInt8]) {
        ...
        case .InvoiceExpired(_ /* message is ignored*/):
            writeInt(&buf, Int32(4))
        case .InvoiceNoDescription(_ /* message is ignored*/):
            writeInt(&buf, Int32(5))
        case .InvoicePreimageAlreadyExists(_ /* message is ignored*/):
            writeInt(&buf, Int32(6))
        case .ServiceConnectivity(_ /* message is ignored*/):
            writeInt(&buf, Int32(7))
        case .InvoiceNoRoutingHints(_ /* message is ignored*/):
...
extension ReceivePaymentError: Foundation.LocalizedError {
    public var errorDescription: String? {
        String(reflecting: self)
    }
}
...
public enum RedeemOnchainError {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRedeemOnchainError: FfiConverterRustBuffer {
    typealias SwiftType = RedeemOnchainError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RedeemOnchainError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: RedeemOnchainError, into buf: inout [UInt8]) {
        switch value {
...
extension RedeemOnchainError: Equatable, Hashable {}

extension RedeemOnchainError: Foundation.LocalizedError {
    public var errorDescription: String? {
        String(reflecting: self)
    }
}
...
public struct FfiConverterTypeReportIssueRequest: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ReportIssueRequest {
        ...
        case 1: return .paymentFailure(data: try FfiConverterTypeReportPaymentFailureDetails.read(from: &buf)
        )
...
public struct FfiConverterTypeSendOnchainError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SendOnchainError, into buf: inout [UInt8]) {
        ...
        case .Generic(_ /* message is ignored*/):
            writeInt(&buf, Int32(1))
        case .InvalidDestinationAddress(_ /* message is ignored*/):
            writeInt(&buf, Int32(2))
        case .OutOfRange(_ /* message is ignored*/):
            writeInt(&buf, Int32(3))
        case .PaymentFailed(_ /* message is ignored*/):
            writeInt(&buf, Int32(4))
        case .PaymentTimeout(_ /* message is ignored*/):
...
extension SendOnchainError: Foundation.LocalizedError {
    public var errorDescription: String? {
        String(reflecting: self)
    }
}
...
public struct FfiConverterTypeSendPaymentError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SendPaymentError {
        ...
        case 12: return .InsufficientBalance(
            message: try FfiConverterString.read(from: &buf)
        )
...
extension SendPaymentError: Foundation.LocalizedError {
    public var errorDescription: String? {
        String(reflecting: self)
    }
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeSwapAmountType: FfiConverterRustBuffer {
    typealias SwiftType = SwapAmountType

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwapAmountType {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: SwapAmountType, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSwapAmountType_lift(_ buf: RustBuffer) throws -> SwapAmountType {
    return try FfiConverterTypeSwapAmountType.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSwapAmountType_lower(_ value: SwapAmountType) -> RustBuffer {
    return FfiConverterTypeSwapAmountType.lower(value)
}



extension SwapAmountType: Equatable, Hashable {}
...
public struct FfiConverterTypeSwapStatus: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwapStatus {
        ...
        case 2: return .waitingConfirmation
        
        case 3: return .redeemable
        
        case 4: return .redeemed
        
        case 5: return .refundable
        ...
        onEvent: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onEvent(
                     e: try FfiConverterTypeBreezEvent.lift(e)
                )
            }
...
private func uniffiCallbackInitEventListener() {
    uniffi_breez_sdk_bindings_fn_init_callback_vtable_eventlistener(&UniffiCallbackInterfaceEventListener.vtable)
}
...
// Put the implementation in a struct so we don't pollute the top-level namespace
fileprivate struct UniffiCallbackInterfaceLogStream {

    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceLogStream = UniffiVTableCallbackInterfaceLogStream(
        log: { (
            uniffiHandle: UInt64,
            l: RustBuffer,
            uniffiOutReturn: UnsafeMutableRawPointer,
            ...
            let makeCall = {
                () throws -> () in
                guard let uniffiObj = try? FfiConverterCallbackInterfaceLogStream.handleMap.get(handle: uniffiHandle) else {
                    throw UniffiInternalError.unexpectedStaleHandle
                }
        ...
        uniffiFree: { (uniffiHandle: UInt64) -> () in
            let result = try? FfiConverterCallbackInterfaceLogStream.handleMap.remove(handle: uniffiHandle)
            if result == nil {
                print("Uniffi callback interface LogStream: handle missing in uniffiFree")
            }
        }
    )
}

private func uniffiCallbackInitLogStream() {
    uniffi_breez_sdk_bindings_fn_init_callback_vtable_logstream(&UniffiCallbackInterfaceLogStream.vtable)
}
...
fileprivate struct FfiConverterCallbackInterfaceLogStream {
    fileprivate static var handleMap = UniffiHandleMap<LogStream>()
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeReverseSwapInfo: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeReverseSwapInfo.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeReverseSwapInfo.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionSequenceTypeMetadataFilter: FfiConverterRustBuffer {
    typealias SwiftType = [MetadataFilter]?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterSequenceTypeMetadataFilter.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterSequenceTypeMetadataFilter.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionSequenceTypeTlvEntry: FfiConverterRustBuffer {
    typealias SwiftType = [TlvEntry]?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterSequenceTypeTlvEntry.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterSequenceTypeTlvEntry.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionSequenceTypeSwapStatus: FfiConverterRustBuffer {
    typealias SwiftType = [SwapStatus]?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterSequenceTypeSwapStatus.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterSequenceTypeSwapStatus.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeMetadataFilter: FfiConverterRustBuffer {
    typealias SwiftType = [MetadataFilter]
    ...
    public static func write(_ value: [MetadataFilter], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeMetadataFilter.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [MetadataFilter] {
        let len: Int32 = try readInt(&buf)
        var seq = [MetadataFilter]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeMetadataFilter.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeTlvEntry: FfiConverterRustBuffer {
    typealias SwiftType = [TlvEntry]
    ...
    public static func write(_ value: [TlvEntry], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeTlvEntry.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [TlvEntry] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeTlvEntry.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeSwapStatus: FfiConverterRustBuffer {
    typealias SwiftType = [SwapStatus]
    ...
    public static func write(_ value: [SwapStatus], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeSwapStatus.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [SwapStatus] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeSwapStatus.read(from: &buf))
        }
        return seq
    }
}
public func connect(req: ConnectRequest, listener: EventListener)throws  -> BlockingBreezServices {
    return try  FfiConverterTypeBlockingBreezServices.lift(try rustCallWithError(FfiConverterTypeConnectError.lift) {
    uniffi_breez_sdk_bindings_fn_func_connect(
...
public func defaultConfig(envType: EnvironmentType, apiKey: String, nodeConfig: NodeConfig) -> Config {
    ...
    uniffi_breez_sdk_bindings_fn_func_default_config(
...
public func mnemonicToSeed(phrase: String)throws  -> [UInt8] {
    return try  FfiConverterSequenceUInt8.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_func_mnemonic_to_seed(
        FfiConverterString.lower(phrase),$0
    )
})
}
public func parseInput(s: String)throws  -> InputType {
    return try  FfiConverterTypeInputType.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_func_parse_input(
        FfiConverterString.lower(s),$0
    )
})
}
public func parseInvoice(invoice: String)throws  -> LnInvoice {
    return try  FfiConverterTypeLNInvoice.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_func_parse_invoice(
        FfiConverterString.lower(invoice),$0
    )
})
}
public func serviceHealthCheck(apiKey: String)throws  -> ServiceHealthCheckResponse {
    return try  FfiConverterTypeServiceHealthCheckResponse.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_func_service_health_check(
...
public func staticBackup(req: StaticBackupRequest)throws  -> StaticBackupResponse {
    return try  FfiConverterTypeStaticBackupResponse.lift(try rustCallWithError(FfiConverterTypeSdkError.lift) {
    uniffi_breez_sdk_bindings_fn_func_static_backup(
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_breez_sdk_bindings_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_func_connect() != 2295) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_func_default_config() != 38312) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_func_mnemonic_to_seed() != 19340) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_func_parse_input() != 46630) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_func_parse_invoice() != 4794) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_backup() != 36004) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_backup_status() != 51417) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_buy_bitcoin() != 36346) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_check_message() != 43483) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_claim_reverse_swap() != 5979) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_close_lsp_channels() != 37352) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_configure_node() != 40371) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_connect_lsp() != 41822) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_disconnect() != 25385) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_execute_dev_command() != 16243) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_fetch_fiat_rates() != 38513) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_fetch_lsp_info() != 40985) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_fetch_reverse_swap_fees() != 56465) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_generate_diagnostic_data() != 22880) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_in_progress_onchain_payments() != 39619) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_in_progress_swap() != 64161) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_list_fiat_currencies() != 54166) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_list_lsps() != 30571) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_list_payments() != 44520) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_list_refundables() != 53017) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_list_swaps() != 14075) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_lnurl_auth() != 23740) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_lsp_id() != 53031) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_lsp_info() != 38310) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_node_credentials() != 5169) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_node_info() != 17807) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_onchain_payment_limits() != 58677) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_open_channel_fee() != 65044) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_pay_lnurl() != 59900) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_pay_onchain() != 34167) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_payment_by_hash() != 8063) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_prepare_onchain_payment() != 38151) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_prepare_redeem_onchain_funds() != 23808) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_prepare_refund() != 19067) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_receive_onchain() != 38436) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_receive_payment() != 65361) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_recommended_fees() != 46238) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_redeem_onchain_funds() != 25372) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_redeem_swap() != 31523) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_refund() != 28853) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_register_webhook() != 51745) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_report_issue() != 20233) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_rescan_swaps() != 30273) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_send_payment() != 21112) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_send_spontaneous_payment() != 62139) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_set_payment_metadata() != 64161) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_sign_message() != 27140) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_sync() != 37323) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_unregister_webhook() != 13931) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_blockingbreezservices_withdraw_lnurl() != 44837) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_eventlistener_on_event() != 53633) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_breez_sdk_bindings_checksum_method_logstream_log() != 5129) {
        return InitializationResult.apiChecksumMismatch
    }

    uniffiCallbackInitEventListener()
    uniffiCallbackInitLogStream()
